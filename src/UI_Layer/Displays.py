...
class Displays:
    ...
    def printProperty(self, property, title_message = "Property Information", error = None, edit_message = "", done_message = "", mode = "") -> None:
        ...
        print(f"Property ID: {property.propertyID}") # For all of these we get a property object from the logic layer and we display it
        ...
        print(f"3.Location: {property.location}" + ("          // Ex. 1 (Valid Destination ID)" if mode == "hints" else ""))
    ...
    def printEmployee(self, employee, title_message = "Employee Information", error = None, edit_message = "", done_message = "", mode = "") -> None:
        ...
        if employee.type == "Contractor": # This is so we can use the same function for both contractor and employees since they share many attributes, use what the logic layer provided us with to print the relevant data
            ...
            print(f"Employee ID: {employee.employeeID}") # For all of these we get an object from the logic layer and we display it
            ...
            print(f"7.Work Location: {employee.workLocation}" + ("       // Ex. 1 (Valid Destination ID)" if mode == "hints" else ""))
            ...
            print(f"10.Contractor Contact: {employee.contractorContact}" + (" // Ex. 1 (Valid Employee ID)" if mode == "hints" else ""))
    ...
    def printMaintenanceTask(self, task, title_message = "Maintenance Task Information", error = None, edit_message = "", done_message = "", mode = "") -> None:
        ...
        print(f"\n--- {title_message} ---")
        print(f"{edit_message}")
        print(f"Maintenance ID: {task.maintenanceID}") # For all of these we get a maintenance object from the logic layer and we display it
        print(f"1.Maintenance done on Property ID: {task.propertyID}" + ("   // Ex. 1 (Valid Property ID)" if mode == "hints" else "")) # These hints are for the creation process, for the other UI's to specify
    ...
    def printMaintenanceSchedule(self, schedule, title_message = "Maintenance Schedule Information", error = None, edit_message = "", done_message = "", mode = "") -> None:
        ...
        print(f"\n--- {title_message} ---")
        print(f"{edit_message}")
        print(f"Maintenance Schedule ID: {schedule.maintenanceScheduleID}") # For all of these we get a maintenance Schedule object from the logic layer and we display it
        print(f"1.Scheduled Maintenance Task ID: {schedule.maintenanceID}" + ("       // Ex. 1 (Valid Maintenance Task ID)" if mode == "hints" else "")) # These hints are for the creation process, for the other UI's to specify
    ...
    def printMaintenanceReport(self, report, title_message = "Maintenance Report Information", error = None, edit_message = "", done_message = "", mode = "") -> None:
        ...
        print(f"\n--- {title_message} ---")
        print(f"{edit_message}")
        print(f"Maintenance Report ID: {report.maintenanceReportID}") # For all of these we get an Maintenance report object from the logic layer and we display it
        print(f"1.Report on Maintenance Task ID: {report.maintenanceID}" + ("                         // Ex. 1 (Valid Maintenance Task ID)" if mode == "hints" else "")) # These hints are for the creation process, for the other UI's to specify
        print(f"2.Employee ID of the Employee that took on the Task: {report.employeeID}" + ("     // Ex. 2 (Valid Employee ID)" if mode == "hints" else ""))
        print(f"3.Cost of materials: {report.materialCost}" + ("                                         // Ex. 1000 (Number With No Currency)" if mode == "hints" else ""))
        print(f"4.Contractor ID of the Contractor that took the Task: {report.contractorID}" + ("    // Ex. 1 (Valid Contractor ID)" if mode == "hints" else ""))
    ...
    def printDestination(self, destination, title_message = "Destination Information", error = None, edit_message = "", done_message = "", mode = "") -> None:
        ...
        print(f"\n--- {title_message} ---")
        print(f"{edit_message}")
        print(f"Destination ID: {destination.destinationID}") # For all of these we get a destination object from the logic layer and we display it
        ...
        print(f"5.Phone ID: {destination.phoneNumber}")
    ...
    def displayEmployees(self, destination = None) -> None:
        ...
        employeespretty.field_names = ["Employee ID", "Employee Name", "Social Security ID", "GSM Phone","Email", "Working at destination", "Type of Employee"]
    ...
    def displayManagers(self, destination = None) -> None:
        ...
        managerspretty.field_names = ["Employee ID", "Employee Name", "Social Security ID", "GSM Phone","Email", "Working at destination", "Type of Employee"]
    ...
    def displayContractors(self, destination=None) -> None:
        ...
        contractors_pretty.field_names = ["Contractor ID", "Name", "Social Security", "GSM Phone", "Email", "Work Location", "Type", "Contractor Contact", "Opening Hours"]
    ...
    def displayProperties(self, destination = None) -> None:
        ...
        propertiespretty.field_names = ["Property ID", "Property Name", "Description", "Location", "Available for rental", "Pool Available"]
